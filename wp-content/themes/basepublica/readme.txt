...
Base Publica WordPress Theme, Copyright 2019-2020 WordPress.org
Base Publica is distributed under the terms of the GNU GPL.
...
Base Publica is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Base Publica bundles the following third-party resources:
...
Bespoke Icons Created For Base Publica
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- basepublica_SVG_Icons
- basepublica_the_theme_svg()
- basepublica_get_theme_svg()
- basepublica_nav_menu_social_icons()
