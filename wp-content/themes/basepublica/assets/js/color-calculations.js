 ...
 * @return {Object} - this
 */
function _basepublicaColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_basepublicaColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_basepublicaColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_basepublicaColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _basepublicaColor object.
 *
 * @since Base Publica 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function basepublicaColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _basepublicaColor( backgroundColor, accentHue );
